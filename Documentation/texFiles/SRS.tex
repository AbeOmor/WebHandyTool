...
\begin{document}
\title{WebHandyTool \\
Software Requirements Specification : newAGEtech, Group H }
...
8& 7-12-15& Revised section 2,10,11 &Abraham Omorogbe\\ \hline
...
This project will be an attempt to ease the difficult and tedious process of verifying a website'Äôs current status and state of availability. As well as being able to assist researchers in scouring the web efficiently for potentially relevant sources of data. Some specific tasks expected to be completed using this software include ensuring all of a website'Äôs pages are functioning correctly and resources that should be available are, data mining for certain research topics and for security professionals ensuring that only the webpages that should be visible are.
...
\textcolor{red}{The client is for this project is McMaster University, in particular Dr Smith, the professor that ordered the project}

\subsection*{The Customer}
\textcolor{red}{The customers of this product will be researchers, web developers and web enthusiast}
...
- Strong knowledge of technology, especially technology involved in this product'Äôs field.\\
...
\subsection*{Solution Constraints}
	This project will be implemented using the Python programming language. This is due to the language‚Äôs simplicity and available libraries related to the project.
...
\section{Naming Conventions \& Definitions}
...
\\
(306) - No longer in use, the code is now reserved.‚àÇ
\\
...
\textbf{Description}:  The product shall able to display website‚Äôs depth\\
...
\textcolor{red}{All this requirement were built as a core part of the system. They will not be phased out in the near future}
...
\textcolor{red}{The crawler should avoid rapid changes in colors, when printing out results, this is a precaution for epileptic uses.}
...
\textcolor{red}{\subsection*{Inability to download files:} The crawler might not be able to download all the resources from the websites, it crawled. This risk will be tested during the proof of concept. The POC will test what files can be accessed and downloaded}
...
User‚Äôs will provided with information on program use via a ‚ÄúHelp‚Äù option which, when selected, will
